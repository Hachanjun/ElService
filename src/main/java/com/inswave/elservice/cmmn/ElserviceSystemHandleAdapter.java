...
public class ElserviceSystemHandleAdapter extends ElSystemHandleAdapter {

 
	public ElserviceSystemHandleAdapter(Map<String, Object> adapterInfoMap) {
		super(adapterInfoMap);
	}

	@Override
	public void preHandle(HttpServletRequest request, String inputData) throws UserException {
		AppLog.debug("[ElserviceSystemHandleAdapter-preHandle]...");
		...
		try{
			...
			new ElserviceAuthProcess().checkAuth(request, svcId, inputData);			
	...
	public void postHandle(ElHeader elHeader, UserHeader userHeader, Object[] serviceParams, Model resultModel) {
		AppLog.debug("[ElserviceSystemHandleAdapter-postHandle]...");
		...
		if( userHeader != null && userHeader instanceof ElserviceUserHeader ) {
