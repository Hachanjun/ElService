...
/**  
 * @Class Name : ElserviceSessionDataAdapter.java
 ...
 */
public class ElserviceSessionDataAdapter extends SessionDataAdapter {
	/**
	 * SessionAdapter 생성자이다.
	 * 
	 * @param adapterInfoMap Adapter 정보
	 */
	public ElserviceSessionDataAdapter(Map<String, Object> adapterInfoMap) {
	 ...
	 * @return ElserviceUserHeader
	 * @throws AdapterException
	 */
	@Override
	public ElserviceUserHeader setSessionData(HttpServletRequest request, String id, Object... obj) throws AdapterException{
