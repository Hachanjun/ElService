...
/**
 * @subject		: ElserviceLoginAdapter.java 
 ...
 * 
 */
public class ElserviceLoginAdapter extends LoginAdapter {
	 ...
	 */
	public ElserviceLoginAdapter(Map<String, Object> adapterInfoMap){
	...
	public LoginInfo login(HttpServletRequest request, String id, Object... params) throws LoginException {
		...
		info.setSuc(true);
		AppLog.debug("[Login] Elservice Login 성공.....");
	...
	public LoginInfo logout(HttpServletRequest request, String id, Object... params) throws LoginException {
		...
		try{			
			...
			// 2. 로그아웃 성공 설정 
			info.setSuc(true);
			AppLog.debug("[Logout] Elservice Logout 성공.....");
