package com.inswave.elservice.emp.vo;
...
public class EmpListVo extends com.inswave.elservice.cmmn.ElserviceCommVO {
    ...
    private java.util.List<com.inswave.elservice.emp.vo.EmpVo> empVoList;
    ...
    private java.util.List<com.inswave.elservice.emp.vo.DeptVo> deptVoList;
    ...
    private com.inswave.elservice.emp.vo.EmpVo empVo;

    public int getEmpCnt(){
        return empVoList != null ? empVoList.size() : 0 ;
    }

    public java.util.List<com.inswave.elservice.emp.vo.EmpVo> getEmpVoList(){
        return empVoList;
    }

    public void setEmpVoList(java.util.List<com.inswave.elservice.emp.vo.EmpVo> empVoList){
        this.empVoList = empVoList;
    }

    public java.util.List<com.inswave.elservice.emp.vo.DeptVo> getDeptVoList(){
        return deptVoList;
    }

    public void setDeptVoList(java.util.List<com.inswave.elservice.emp.vo.DeptVo> deptVoList){
        this.deptVoList = deptVoList;
    }

    public com.inswave.elservice.emp.vo.EmpVo getEmpVo(){
        return empVo;
    }

    public void setEmpVo(com.inswave.elservice.emp.vo.EmpVo empVo){
        this.empVo = empVo;
    }
	...
	public byte[] marshalFld(String encode) throws Exception{
        ...
        try {
            ...
            for( int i=0 ; empVoList != null && i < empVoList.size() ; i++ ) {
                com.inswave.elservice.emp.vo.EmpVo vo = (com.inswave.elservice.emp.vo.EmpVo)empVoList.get(i);
    ...
    public void unMarshalFld( byte[] bytes , String encode) throws Exception{
        try{ 
             ...
             {
                 java.util.List<com.inswave.elservice.emp.vo.EmpVo> alList = new java.util.ArrayList<com.inswave.elservice.emp.vo.EmpVo>();
                 for( int i=0 ; i < empCnt ; i++ ) {
                     com.inswave.elservice.emp.vo.EmpVo vo = new com.inswave.elservice.emp.vo.EmpVo(_offset);
    ...
    public void _xStreamEnc() {
        ...
        for( int i=0 ; deptVoList != null && i < deptVoList.size() ; i++ ) {
            com.inswave.elservice.emp.vo.DeptVo vo = (com.inswave.elservice.emp.vo.DeptVo)deptVoList.get(i);
            vo._xStreamEnc();	 
        }
