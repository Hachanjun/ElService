package com.inswave.elservice.emp.web;
...
import com.inswave.elservice.cmmn.ElserviceUserHeader;
import com.inswave.elservice.cmmn.tcp.ElserviceTcpLengthBaseSendUtil;
import com.inswave.elservice.emp.service.EmpFileService;
import com.inswave.elservice.emp.service.EmpService;
import com.inswave.elservice.emp.vo.DeptListVo;
import com.inswave.elservice.emp.vo.EmpListVo;
...
public class EmpController {
    ...
    public void login(com.inswave.elservice.emp.vo.LoginVo loginVo, HttpServletRequest request) throws Exception {
    ...
    public void loginFrm(com.inswave.elservice.emp.vo.LoginVo loginVo, HttpServletRequest request) throws Exception {    
		String id = loginVo.getId();
	...
	public EmpVo tcpSendTest(EmpVo empVo) throws Exception {
		...
		ElserviceUserHeader userHeader = new ElserviceUserHeader();
		userHeader.setSvcId("DmoEmpSelect");
		userHeader.setTestId("TEST_ID");
		
		ElResDataVO resVo = ElserviceTcpLengthBaseSendUtil.sendFld("localhost", 9999, userHeader, eInVo, eOutVo, 10, false, "EUC-KR");
		
		EmpVo resEmpVo = (EmpVo) resVo.getVo();
		ElserviceUserHeader resUserHeader =(ElserviceUserHeader) resVo.getUserHeader();
