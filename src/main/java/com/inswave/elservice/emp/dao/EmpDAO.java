...
import com.inswave.elservice.emp.vo.DeptVo;
 ...
 */
@Repository("empDAO")
public class EmpDAO extends ElserviceDefaultAbstractDAO {
    ...
    public int insertEmp(EmpVo empVo) throws ElException {
        return insert("com.inswave.elservice.emp.insertEmp", empVo);
    }
    ...
    public int updateEmp(EmpVo empVo) throws ElException {
        return update("com.inswave.elservice.emp.updateEmp", empVo);
    }
    ...
    public int deleteEmp(EmpVo empVo) throws ElException {
    	return delete("com.inswave.elservice.emp.deleteEmp", empVo);
    }
    ...
    public EmpVo selectEmp(EmpVo empVo) throws ElException {
        return (EmpVo) selectByPk("com.inswave.elservice.emp.selectEmp", empVo);
    }
    ...
    public List<EmpVo> selectListEmp(EmpVo empVo) throws ElException {
        ...
        return list("com.inswave.elservice.emp.selectListEmp", empVo);
    }
    ...
    public long selectListCountEmp(EmpVo empVo) throws ElException {
        return (Long) selectByPk("com.inswave.elservice.emp.selectListCountEmp", empVo);
    }
    ...
    public ArrayList<DeptVo> selectListDept(HashMap searchKeyHm) throws ElException {
    	return (ArrayList<DeptVo>) list("com.inswave.elservice.emp.selectListDept", searchKeyHm);
    }
